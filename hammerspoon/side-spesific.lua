...
--
SIDE_SPECIFIC_HOTKEYS = {
  -- A limitation to this approach is that you can't remap ONLY modifier keys
  -- For example, you can't map rightCmd+a to ctrl+a
  {'rightCmd', 'w', nil, 'up'},
  {'rightCmd', 'a', nil, 'left'},
  {'rightCmd', 's', nil, 'down'},
  {'rightCmd', 'd', nil, 'right'},
  {'rightCmd', 'q', 'alt', 'left'},
  {'rightCmd', 'e', 'alt', 'right'},
  {'rightCmd+rightShift', 'w', 'shift', 'up'},
  {'rightCmd+rightShift', 'a', 'shift', 'left'},
  {'rightCmd+rightShift', 's', 'shift', 'down'},
  {'rightCmd+rightShift', 'd', 'shift', 'right'},
  {'rightCmd+rightShift', 'q', 'alt+shift', 'left'},
  {'rightCmd+rightShift', 'e', 'alt+shift', 'right'},
}
