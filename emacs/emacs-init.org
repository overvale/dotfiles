...
To improve startup time, I follow the [[https://github.com/hlissner/doom-emacs/blob/develop/docs/faq.org#how-does-doom-start-up-so-quickly][advice given by Doom Emacs]].
...
These are all stolen (with comments) from [[https://github.com/hlissner/doom-emacs/blob/develop/core/core.el][Doom Emacs]].
