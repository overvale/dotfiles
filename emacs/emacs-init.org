...
As described by /prot/ [[https://protesilaos.com/codelog/2020-09-05-emacs-note-mixed-font-heights/][here]].

#+begin_src emacs-lisp
(set-face-attribute 'default nil
		    :family "Iosevka Fixed SS08" :height 145)
(set-face-attribute 'variable-pitch nil
		    :family "IBM Plex Serif" :height 1.05)

;; This is calculated from 'default' when NOT in 'variable-pitch-mode'
;; and calculated from 'variable-pitch' when you ARE.
(set-face-attribute 'fixed-pitch nil
		    :family "Iosevka Fixed SS08" :height 0.95)
...
(use-package elfeed
  ...
  (setq elfeed-search-filter "@1-month1-ago +unread")
